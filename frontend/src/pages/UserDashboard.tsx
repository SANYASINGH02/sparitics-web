...
export default function UserDashboard() {
  ...
  const [activeHref, setActiveHref] = useState('/user');
    ...
    <AppLayout
      ...
      content={
        <SpaceBetween size="l">
          ...
          <Container header={<Header variant="h1">User Dashboard</Header>}>
            <SpaceBetween size="m">
              <Box variant="p">
                Welcome, <strong>{userID}</strong>. Use the navigation menu or start counting below.
              </Box>
              <Button variant="primary" onClick={() => navigate('/counting')}>
                Start Counting
              </Button>
            </SpaceBetween>
          </Container>
